...
disp(['Prima Call Vanilla: ',num2str(primacall)])
%% Short RKI Put
...
barrera = 20.30;
primaKOPut= barrierbybls(CurvaTasas,detallesuby,opttipo,strike,settle,fechaejercicio,barreratipo,barrera);
disp(['Prima KO Put : ',num2str(primaKOPut)])
%% Total
total = - primacall - primaKOPut ;
